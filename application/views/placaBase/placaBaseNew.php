        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <h1 class="text-center">Creacion Placa Base</h1>
                </div>
                <br><br>
                <div class="row">
                    <div class="col-sm-6 m-3">
                        <?php
                        $atributos = array('class' => 'form-group', 'id' => 'crearNuevaPlaca');
                        echo form_open_multipart('placaBaseController/crearPlacaBd', $atributos);
                        ?>
                ...
                <div class="row">
                    <div class="col-sm-12 m-3">
                        <div class="md-form pr-3 mr-3">
                            <i class="fas fa-pencil-alt prefix"></i>
                            <textarea name="descripcion" id="form10" class="md-textarea form-control" rows="5"></textarea>
